...
### Changed
- Refactored transliterator: extracted private methods, improved variable names
- Extracted magic strings to LANG_* constants and POLISH_DIGRAPHS constant
- Cleaned up gemspec metadata (fixed source_code_uri, removed Czech from description)
- Clarified Czech support as diacritics-only in README
- Removed TODO section from README
- Added exceptions.yml to gem

### Fixed
- Eliminated gem build warning for duplicate homepage/source_code URIs
